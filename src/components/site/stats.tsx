      ...
      <section className="relative z-30 px-4 sm:px-6 pt-2 pb-1">
        <div className="container mx-auto max-w-7xl">
          <Reveal variant="elastic" delay={0}>
            <div className="rounded-2xl bg-gradient-to-r from-xavier-dark via-xavier to-xavier-dark text-cream-fg p-3 sm:p-4 flex items-center justify-center gap-3 sm:gap-4 shadow-elegant animate-pulse-glow ambient-float">
