        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-4">
          {filtered.map((item, i) => (
            <Reveal
              ...
              className={`group relative overflow-hidden rounded-xl sm:rounded-2xl aspect-square depth-card text-left ring-2 ring-transparent hover:ring-gold/50 transition-all duration-300 hover-grow ${
