                  ...
                  {fields.map((field) => (
                    <div key={field.name} className={field.colSpan}>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-xavier/15 bg-cream/40 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-xavier/30 focus:border-xavier/40 transition-colors"
                      />
                    </div>
                  ))}
                </div>
