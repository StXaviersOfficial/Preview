            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-3">
              {QUICK_FACTS.map((fact, i) => (
                <Reveal
                  ...
                  variant="elastic"
                  delay={i * 0.05}
                  className="progressive-reveal slide-ltr flex items-start gap-3 rounded-2xl border border-xavier/10 bg-card p-3 sm:p-4 hover:border-gold/40 hover:shadow-elegant transition-all"
                >
