          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {TOPPERS.map((t, i) => (
              <Reveal
                ...
                variant="elastic"
                delay={i * 0.04}
                className={`card-lift card-3d-tilt shine-card rounded-2xl border p-5 hover:border-gold/40 hover-glow ${t.highlight ? "border-gold/40 bg-gradient-to-br from-gold/8 to-xavier/5" : "border-xavier/10 bg-card"}`}
              >
